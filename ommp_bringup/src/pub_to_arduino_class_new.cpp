...
public:
  arduinoHandler() {
    ...
    arm_pub =
        nh.advertise<std_msgs::Int32MultiArray>("/command", 10);
  }
...
void jsCB(const sensor_msgs::JointState::ConstPtr &joint_state) {
  ...
  int helper = (8300 - servo_1 + 2750); // link1 5150 -> link2 5900 and reverse
  ...
  int servo_5 = 450 - this->map(curr_5, 2000, 8300);
