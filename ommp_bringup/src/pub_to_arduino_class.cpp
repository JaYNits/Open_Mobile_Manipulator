...
public:
	...
	void jsCB(const sensor_msgs::JointState::ConstPtr& joint_state)
	{
        ...
        float curr_6 = joint_state->position[10];
    	...
    	if(cond_0 && cond_1 && cond_2 && cond_3 && cond_4 && cond_5 && cond_6){return;}
        ...
        if (servo_6 > 380){servo_6 = 380;}
        if (servo_6 < 230){servo_6 = 230;}
...
protected:
	...
	float prev_0=0,prev_1=0,prev_2=0,prev_3=0,prev_4=0,prev_5=0,prev_6=0;
};
