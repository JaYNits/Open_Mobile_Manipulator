...
public:
  ...
  void jsCB(const sensor_msgs::JointState::ConstPtr &joint_state) {
    ...
    curr_0 = joint_state->position[5];
    curr_1 = joint_state->position[6];
    curr_2 = joint_state->position[7];
    curr_3 = joint_state->position[8];
    curr_4 = joint_state->position[9];
    curr_5 = joint_state->position[10];
    curr_6 = joint_state->position[11];
